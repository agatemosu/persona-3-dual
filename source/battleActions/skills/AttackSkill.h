...
struct AttackSkill : Skill
{
    ...
    u32 calculateDamagePlayer(BattleStats* attackerStats,
    ...
    u32 calculateDamageEnemySkill(BattleStats* attackerStats,
                                  BattleStats* defenderStats,
                                  u32* attackerLevel,
                                  u32* defenderLevel,
                                  Armour* armour = nullptr);
    u32 calculateDamageEnemyRegular(BattleStats* attackerStats,
                                    BattleStats* defenderStats,
                                    u32* attackerLevel,
                                    u32* defenderLevel,
                                    Armour* armour = nullptr);
