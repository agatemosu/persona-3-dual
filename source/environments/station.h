...
// Source: station.obj
// Scale: 0.213904  Centred: True  max_tex_size: 64
...
// World bounds
#define STATION_WORLD_OFFSET_X 1.283423f
#define STATION_WORLD_OFFSET_Z 3.000000f
#define STATION_WORLD_WIDTH    2.566845f
#define STATION_WORLD_DEPTH    6.000000f

enum station_TexSlot {
    STATION_TEX_F008_005OBJ04 = 0,
    STATION_TEX_F008_005OBJ02 = 1,
    STATION_TEX_F008_005OBJ07 = 2,
    STATION_TEX_F008_005OBJ06 = 3,
    STATION_TEX_F008_005OBJ08 = 4,
    STATION_TEX_LIGHTMAP_WHITE = 5,
    STATION_TEX_F008_005WALL01 = 6,
    STATION_TEX_F008_005OBJ01 = 7,
    STATION_TEX_F008_005OBJ03 = 8,
    STATION_TEX_F008_005FLOOR01 = 9,
    STATION_TEX_F008_005BOLT01 = 10,
    STATION_TEX_COUNT = 11
};

struct station_BillboardData {
    v16 x, y, z;
...
public:
    ...
    const station_BillboardData* BILLBOARDS = NULL;
    ...
    bool load(const char* filepath, const unsigned int* bitmaps[11]) {
        ...
        if (groupCount != 11) { fclose(file); return false; }
    ...
    void drawBillboards(bool faceCamera, float camX, float camY, float camZ) {
        ...
        for (int i = 0; i < BILLBOARD_COUNT; i++) {
            const station_BillboardData& bb = BILLBOARDS[i];
    ...
    void cleanup() {
        ...
        glDeleteTextures(11, textureIDs);
    }
};
